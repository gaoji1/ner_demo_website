    ...
    return (
        <React.Fragment>
            <Card className={classes.card}>
                ...
                title={<Typography variant="h6">{props.modelName}</Typography>}  //中间的文字
                action={
                ...
                <CardActions>
                    <Grid container justify="flex-end" spacing={1}>
                        <Grid item xs={3}>
                            ...
                            variant="contained" color="secondary">报告识别错误</Button>
                        </Grid>
                    </Grid>
                </CardActions>
            </Card>
...
// OutputCard.getInitialProps = async ({req}) => {
//     let modelOutList = [["示例文本1", "Tag1"], ["示例文本4", "O"],["示例文本5", "O"],["文本2", "Tag2"],["示例文本3", "Tag3"], ["示例文本1", "Tag1"], ["示例文本1", "Tag1"], ["示例文本1", "Tag1"], ["示例文本1", "Tag1"]]
